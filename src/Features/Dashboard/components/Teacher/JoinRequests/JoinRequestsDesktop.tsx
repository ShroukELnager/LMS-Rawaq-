...
import { JoinGroupResponse, JoinRequestsDesktopProps } from "@/Features/Dashboard/Types";
                ...
                (row: JoinGroupResponse) => (
                  ...
                  >
                    ...
                    <td className="relative px-6 py-4">
                      ...
                      {openMenu === row.id && (
                        <div className="absolute right-6 top-14 z-50 min-w-[200px] rounded-xl border border-gray-200 bg-white shadow-lg">
                          <button className="flex w-full items-center gap-3 px-4 py-3 hover:bg-green-50">
                            <Image
                          ...
                          <button className="flex w-full items-center gap-3 px-4 py-3 hover:bg-red-50">
                            <Image
