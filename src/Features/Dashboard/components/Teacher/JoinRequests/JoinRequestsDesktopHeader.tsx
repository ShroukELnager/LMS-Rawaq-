...
export default function JoinRequestsHeader({
  ...
  <span className="inline-flex h-7 min-w-[36px] items-center justify-center rounded-full bg-[#F5E7B8] px-3 text-sm font-semibold text-w">
    {count}
  </span>
</h1>
      ...
      <div className="mt-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div className="relative w-full md:w-1/2 lg:w-1/3">
          ...
          <input
            ...
            className="w-full rounded-xl border border-gray-300 bg-white py-3 pl-11 pr-4 text-sm outline-none focus:border-primary"
          />
        </div>
